<%-- 
    Document   : admin
    Created on : Apr 24, 2017, 2:14:42 AM
    Author     : Fatemeh-pc
--%>
	...
	<ul id="nav-mobile" class="side-nav right fixed">
		...
		<li class="right-align">
			<ul class="collapsible collapsible-accordion">
				<li class="bold">
					<a class="collapsible-header waves-effect waves-teal">سرتیتر اول<i
							class="material-icons">arrow_drop_down</i></a>
					<div class="collapsible-body">
						<ul>
							<li><a href="#">زیرتیتر اول</a></li>
							<li><a href="#">زیرتیتر دوم</a></li>
							<li><a href="#">زیرتیتر سوم</a></li>
							<li><a href="#">زیرتیتر چهارم</a></li>
						</ul>
					</div>
				</li>
				<li class="bold">
					<a class="collapsible-header waves-effect waves-teal">سرتیتر دوم<i
							class="material-icons">arrow_drop_down</i></a>
					<div class="collapsible-body">
						<ul>
							<li><a href="#">زیرتیتر اول</a></li>
