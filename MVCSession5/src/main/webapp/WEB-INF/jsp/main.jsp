	...
	<nav class="main-nav">
		<div class="nav-wrapper">
			...
			<ul class="side-nav" id="mobile-nav">
				<li class="center">
					<img src="${pageContext.request.contextPath}/resources/img/saja_logo.png" alt="سجا" class="logo">
				</li>
	...
	<div id="login-modal" class="modal">
			...
			<div class="modal-content">
				...
				<p>نام کاربری و رمز عبور را وارد کنید</p>
                                <p class = "error-message hidden">نام کاربری یا رمز عبور نامعتبر است</p>
				<div class="row">
					<div class="col s12">
			...
			<!--testing model -->
			<!--
                                <button onclick="RedirectURL();return false;" class="btn-flat waves-effect waves-light" name="action" id="submit-btn" >ورود
...
<main>
	...
	<div id="main-slider">
		<!--<div class="container">-->
		<div class="carousel">
			<a class="carousel-item" href="#one!"><img src="${pageContext.request.contextPath}/resources/img/01.jpg"></a>
			<a class="carousel-item" href="#two!"><img src="${pageContext.request.contextPath}/resources/img/02.jpg"></a>
			<a class="carousel-item" href="#three!"><img src="${pageContext.request.contextPath}/resources/img/03.jpg"></a>
			<a class="carousel-item" href="#four!"><img src="${pageContext.request.contextPath}/resources/img/04.jpg"></a>
			<a class="carousel-item" href="#five!"><img src="${pageContext.request.contextPath}/resources/img/05.jpg"></a>
		</div>
		<!--</div>-->
	</div>
